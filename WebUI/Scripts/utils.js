utils = function ($) {
    ...
    return {
        ...
        itemEdited: function (gridId, nof, noTrigEdit) {
        ...
        gridModelBuilder: function (o, gridParams, items, opt) {
            ...
            function buildData(lazyKey) {
                var gridModel = buildGroupView(pageItems, lazyKey ? [] : gridParams.Groups, gridParams.Headers, 0, "$" + page, !!lazyKey);
